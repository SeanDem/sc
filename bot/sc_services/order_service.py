...
class OrderService:
    ...
    def attempt_buy(self, pair: CurrencyPair, qty: str, price: str) -> None:
        ...
        qty_to_order: float = min(usdc_available_float, qty_float) #should be fine but may cause issues 
    ...
    def attempt_sell(self, pair: CurrencyPair, qty: str, price: str) -> None:
        ...
        qty_to_order: float = min(token_available_float, qty_float) #should be fine but may cause issues 
